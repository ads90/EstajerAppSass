    ...
    export class ShipmentService {
        ...
        getShipmentsMini() {
            return Promise.resolve(this.getShipmentsData().slice(0, 5));
        }
    
        getShipmentsSmall() {
            return Promise.resolve(this.getShipmentsData().slice(0, 10));
        }
    
        getShipments() {
            return Promise.resolve(this.getShipmentsData());
        }
    
        getShipmentsWithShipmentsSmall() {
            return Promise.resolve(this.getShipmentsWithShipmentsData().slice(0, 10));
        }
    
        getShipmentsWithShipments() {
            return Promise.resolve(this.getShipmentsWithShipmentsData());
        }
    };