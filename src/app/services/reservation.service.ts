...
export class ReservationService {
    ...
    getReservationsMini() {
        return Promise.resolve(this.getReservationsData().slice(0, 5));
    }

    getReservationsSmall() {
        return Promise.resolve(this.getReservationsData().slice(0, 10));
    }
    ...
    getReservationsWithItemsSmall() {
        return Promise.resolve(this.getReservationsWithItemsData().slice(0, 10));
    }

    getReservationsWithItems() {
        return Promise.resolve(this.getReservationsWithItemsData());
    }
};
